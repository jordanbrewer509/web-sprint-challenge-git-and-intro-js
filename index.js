...
const firstArtistName = artists[0]
console.log(firstArtistName['name']);

//(2) Bio of the third artist (2nd index) in the array 

const thirdArtistBio = artists[2]
...
🌟 EXAMPLE: if getArtistByIndex is invoked with th e artists array and the number 0, it will return `the artist at index 0 is Amedeo Modigliani` */
...
newList.push(newArtist);
  return newList;

}
console.log(addArtist(artists, 'Jordan Brewer', '1997 - present', 'Electro', 'White', 'lorem ipsum'));
